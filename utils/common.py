...
LabelSpan = namedtuple("LabelSpan", ['start_idx', 'end_idx', 'label_id'])
LabelSpanWithScore = namedtuple("LabelSpanWithScore", [
                                'start_idx', 'end_idx', 'label_id', 'start_score', 'end_score'])
EntityLabel = namedtuple("EntityLabel", ['text', 'label'])
EntityLabelWithScore = namedtuple(
    "EntityLabelWithScore", ['text', 'label', 'start_score', 'end_score'])
EventTypeLabel = namedtuple("EventTypeLabel", ['text', 'label'])
...
def stat_cuda(msg):
    ...
    stat_dict = {
        ...
        'max_memory_cached': torch.cuda.max_memory_cached() / 1024 / 1024
    }
    print('allocated: %dM, max allocated: %dM, cached: %dM, max cached: %dM' % (
        stat_dict['memory_allocated'],
        stat_dict['max_memory_allocated'],
        stat_dict['memory_cached'],
        stat_dict['max_memory_cached']
    ))
...
def load_model(model, model_path, model_name="pytorch_model.bin"):
    '''
    加载模型
    :param model:
    :param model_name:
