...
class BertForSequenceClassificationWithLabel(nn.Module):
    def __init__(self, args, input_dropout=0.0):
        super(BertForSequenceClassificationWithLabel, self).__init__()
        self.label_num = args.first_label_num
        self.encoder_config = BertConfig.get_config_dict(
            args.model_name_or_path)[0]
...
class BertForSequenceClassificationWithLabelSiamese(nn.Module):
    def __init__(self, args, input_dropout=0.0):
        super(BertForSequenceClassificationWithLabelSiamese, self).__init__()
        self.label_num = args.first_label_num
        self.encoder_config = BertConfig.get_config_dict(
            args.model_name_or_path)[0]
        self.hidden_size = self.encoder_config['hidden_size']
