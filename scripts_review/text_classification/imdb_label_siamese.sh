...
DATA_NAME=imdb
MODEL_TYPE=text_classification_with_label_siamese
...
python ../../run_classifier.py \
  ...
  --label_str_file ${DATA_DIR}/${DATA_NAME}/label_annotation.txt \
  --first_label_file ${DATA_DIR}/${DATA_NAME}/label_map.json \
  --glove_label_emb_file ${DATA_DIR}/${DATA_NAME}/glove_emotional_orientation_cased_whole_300d.npy \
