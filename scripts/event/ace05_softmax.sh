...
DATA_NAME=ace05
MODEL_TYPE=trigger_extraction_softmax
SAVE_NAME=event/${DATA_NAME}/${PRETRAIN_MODEL}_${DATA_NAME}_${MODEL_TYPE}_softmax_1

python ../../run_trigger_extraction_crf.py \
  --use_cuda true \
  --do_train true \
  --do_eval true \
  --do_lower_case false \
